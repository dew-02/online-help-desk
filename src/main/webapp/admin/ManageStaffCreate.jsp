...
<title>Create Staff Details</title>
...
<body class="bg-gray-100 h-screen">
  ...
  <div class="flex h-screen">
    ...
    <div class="flex-1 flex flex-col">
      ...
      <main class="p-6 overflow-auto">
        <div class="bg-white shadow rounded-lg p-6 max-w-3xl mx-auto">Create New Record<br><br>
  ...
  <div class="flex justify-end gap-4 pt-4">
    ...
    <button type="submit" class="px-4 py-2 bg-orange-600 text-white rounded hover:bg-orange-700">
      <i class="fas fa-check mr-1" onclick="window.location.href='admin';"></i> Create Admin
    </button>
  </div>
</form>
