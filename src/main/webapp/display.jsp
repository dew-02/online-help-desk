...
<div class="flex justify-end mb-4">
  <button onclick="window.location.href='AnnInsertServlet';" 
  ...
  <c:forEach var="announcement" items="${allAnnouncements}">
    <div class="announcement-card flex border bg-gray-100 rounded shadow">
      ...
      <div class="flex items-center p-4 gap-2">
        <a href="update.jsp?annid=${announcement.annid}&title=${announcement.title}&content=${announcement.content}&date=${announcement.date}">
          <button class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm">
            <i class="fas fa-pen"></i> Update
          </button>
        </a>
        <form action="AnnDeleteServlet" method="post">
          <input type="hidden" name="annid" value="${announcement.annid}" />
